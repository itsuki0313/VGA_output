...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/c:/Users/ikeno/Documents/VIVADO/vga_test/vga_test.srcs/sources_1/ip/clk_wiz_0/clk_wiz_v5_3_1" \
       +incdir+"../../../../vga_test.srcs/sources_1/ip/clk_wiz_0/clk_wiz_v5_3_1"
}
